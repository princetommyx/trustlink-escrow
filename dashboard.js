    ...
    return `
        <div class="line-item-row" data-id="${lineItemCounter}">
            <div class="form-group" style="flex: 2;">
                <label for="line-prod-${lineItemCounter}">Product/Service</label>
                <select id="line-prod-${lineItemCounter}" class="escrow-product-select" required style="background: rgba(0, 0, 0, 0.3);">
                    ${optionsHTML}
                </select>
            </div>
            <div class="form-group" style="flex: 0.5;">
                <label for="line-qty-${lineItemCounter}">Qty</label>
                <input type="number" id="line-qty-${lineItemCounter}" class="escrow-qty" value="1" min="1" required style="background: rgba(0, 0, 0, 0.3);">
            </div>
            ${lineItemCounter > 1 
